...
from tridet.data.datasets.custom.build import build_monocular_kitti3d_dataset, register_kitti_3d_metadata
...
DATASET_DICTS_BUILDER = {
    ...
    "inference": (build_monocular_kitti3d_dataset, dict(mv3d_split='inference', calib_file='default_calib.txt'))
}
